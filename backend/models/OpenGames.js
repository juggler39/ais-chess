...
const OpenGameSchema = new Schema({
	players: { player1ID: String, player1Name: String, player1Color: String, player1Rating: Number, player2ID: String, player2Name: String, player2Color: String, player2Rating: Number },
